package Hotel.usuario.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleValidationExceptions(MethodArgumentNotValidException ex, WebRequest request) {
        ...
        log.warn("Fallo de validacion en usuario: {} [URI: {}]", errors, request.getDescription(false));
        ...
        ApiError apiError = ApiError.builder()
                ...
                .code("VALID-001")
                .message("Uno o mas campos del usuario no cumplen con los requisitos")
                .validations(errors)
    ...
    public ResponseEntity<ApiError> handleAll(Exception ex, WebRequest request) {
        log.error("Error no controlado en usuario: {} [URI: {}]", ex.getMessage(), request.getDescription(false), ex);
